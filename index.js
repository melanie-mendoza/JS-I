...
function carMaker(num) {
  // returns an object with the characteristics:
  //    1. an odometer property 
  let car = {
    odometer: num,
  //    2. drive method - distance as argument
  //        a. when distance increases, odometer in the object increases
  //        b. returns the updated value of the odometer 
